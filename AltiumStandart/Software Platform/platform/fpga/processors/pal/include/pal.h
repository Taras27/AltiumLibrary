...
extern int              pal_lsbit32_index(long l);
extern int              pal_lsbit64_index(long long ll);
extern int              pal_msbit32_index(long l);
extern int              pal_msbit64_index(long long ll);
#endif
