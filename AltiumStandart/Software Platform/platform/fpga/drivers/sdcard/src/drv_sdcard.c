 ...
 * Returns SD_ERR_OK if successful, an error code otherwise.
 */
inline int sdcard_device_init( sdcard_t * restrict sdcard, drv_sdcard_cfg_instance_t * restrict cfg )
{
    uint16_t blkdiv;
    csd_t csd;
    cid_t cid;
...
extern sdcard_t *sdcard_open( unsigned int id )
{
    ...
    return sdcard->init ? sdcard : NULL;
}
