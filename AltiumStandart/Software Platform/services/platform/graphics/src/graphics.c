...
graphics_t *graphics_open(unsigned int id)
{
    ...
    if (graphics->initialized == false)
    {
        ...
        {
            canvas_initialize(&graphics->canvases[0], (uintptr_t)srv_cfg->canvasbuffer1, srv_cfg->color_format, srv_cfg->canvas_width, srv_cfg->canvas_height, srv_cfg->rotation, srv_cfg->default_font);
        }
#endif
        ...
        {
            canvas_initialize(&graphics->canvases[1], (uintptr_t)srv_cfg->canvasbuffer2, srv_cfg->color_format, srv_cfg->canvas_width, srv_cfg->canvas_height, srv_cfg->rotation, srv_cfg->default_font);
        }
#endif
        ...
        {
            canvas_initialize(&graphics->canvases[2], (uintptr_t)srv_cfg->canvasbuffer3, srv_cfg->color_format, srv_cfg->canvas_width, srv_cfg->canvas_height, srv_cfg->rotation, srv_cfg->default_font);
        }
#endif
        ...
        {
            canvas_initialize(&graphics->canvases[3], (uintptr_t)srv_cfg->canvasbuffer4, srv_cfg->color_format, srv_cfg->canvas_width, srv_cfg->canvas_height, srv_cfg->rotation, srv_cfg->default_font);
        }
#endif
