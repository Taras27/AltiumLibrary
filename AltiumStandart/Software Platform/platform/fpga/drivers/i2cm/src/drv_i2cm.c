...
i2cm_t * i2cm_open( int id )
{
    ...
    drv_i2cm_cfg_instance_t * restrict drv_cfg = &drv_i2cm_instance_table[id];
    per_i2cm_cfg_instance_t * restrict per_cfg = &per_i2cm_instance_table[drv_cfg->per_i2cm];
 ...
 *
 * @return     -1 on error, received byte otherwise
 */
